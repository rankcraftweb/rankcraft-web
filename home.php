...
<section class="service-hero">
	<div class="container service-hero-inner">
		...
		<div class="service-hero-visual"><svg class="hero-illustration" viewBox="0 0 400 300" aria-hidden="true" focusable="false"><rect x="52" y="22" width="296" height="46" rx="12" fill="#0F3252" stroke="#2A5F92" stroke-width="1.5"/><rect x="32" y="52" width="336" height="216" rx="16" fill="#123A5E" stroke="#2A5F92" stroke-width="1.5"/><rect x="62" y="84" width="140" height="10" rx="5" fill="#63C89F"/><g fill="#3C6E9C"><rect x="62" y="114" width="276" height="8" rx="4"/><rect x="62" y="134" width="240" height="8" rx="4"/><rect x="62" y="154" width="262" height="8" rx="4"/><rect x="62" y="182" width="196" height="8" rx="4"/><rect x="62" y="202" width="252" height="8" rx="4"/><rect x="62" y="222" width="174" height="8" rx="4"/></g><rect x="62" y="246" width="88" height="8" rx="4" fill="#F4F6F9"/></svg></div>
	</div>
</section>
