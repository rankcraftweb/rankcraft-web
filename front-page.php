...
<section class="hero" id="free-audit">
			...
			<svg class="hero-visual-svg" viewBox="0 0 620 520" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="rc-hero-visual-title">
				...
				<defs>
					<linearGradient id="rc-screen" x1="0" y1="0" x2="0" y2="1">
						<stop offset="0" stop-color="#DCE4ED"/>
					...
					<linearGradient id="rc-area" x1="0" y1="0" x2="0" y2="1">
						<stop offset="0" stop-color="#17805F" stop-opacity=".38"/>
						<stop offset="1" stop-color="#17805F" stop-opacity="0"/>
					</linearGradient>
					<radialGradient id="rc-glow" cx="50%" cy="45%" r="62%">
						<stop offset="0" stop-color="#17805F" stop-opacity=".16"/>
						<stop offset="1" stop-color="#17805F" stop-opacity="0"/>
					</radialGradient>
				</defs>
				...
				<!-- Laptop -->
				<rect x="150" y="88" width="400" height="256" rx="12" fill="#F4F6F9"/>
				<rect x="162" y="100" width="376" height="232" rx="6" fill="url(#rc-screen)"/>
				<path d="M148 344 H552 L588 382 H112 Z" fill="url(#rc-base)" stroke="#B9C6D6" stroke-width="2" stroke-linejoin="round"/>
				<path d="M152 347 H548" stroke="#B9C6D6" stroke-width="2" opacity=".55"/>

				<!-- Browser chrome -->
				<path d="M162 106a6 6 0 0 1 6-6h364a6 6 0 0 1 6 6v26H162Z" fill="#F4F6F9"/>
				<circle cx="180" cy="116" r="4" fill="#B9C6D6"/>
				<circle cx="194" cy="116" r="4" fill="#B9C6D6"/>
				<circle cx="208" cy="116" r="4" fill="#B9C6D6"/>
				<rect x="228" y="108" width="210" height="16" rx="8" fill="#E2E8F0"/>
				<rect x="237" y="114" width="7" height="6" rx="1.5" fill="#17805F"/>
				<path d="M238.6 114v-1.8a1.9 1.9 0 0 1 3.8 0V114" fill="none" stroke="#17805F" stroke-width="1.2"/>
				<rect x="252" y="114" width="90" height="5" rx="2.5" fill="#B9C6D6"/>

				<!-- Page being built -->
				<rect x="190" y="158" width="186" height="16" rx="4" fill="#0C2A4A" opacity=".92"/>
				<rect x="190" y="184" width="248" height="9" rx="4.5" fill="#8496AC"/>
				<rect x="190" y="200" width="196" height="9" rx="4.5" fill="#8496AC" opacity=".7"/>
				<rect x="190" y="224" width="96" height="28" rx="7" fill="#17805F"/>
				<rect x="296" y="224" width="88" height="28" rx="7" fill="none" stroke="#17805F" stroke-width="1.5" opacity=".7"/>
				...
				<!-- Performance score -->
				<g>
					<rect x="34" y="140" width="190" height="104" rx="14" fill="url(#rc-card)" stroke="#B9C6D6" stroke-width="1.5"/>
					<circle cx="79" cy="192" r="27" fill="none" stroke="#D3DCE7" stroke-width="8"/>
					<circle cx="79" cy="192" r="27" fill="none" stroke="#17805F" stroke-width="8" stroke-linecap="round" stroke-dasharray="168 170" transform="rotate(-90 79 192)"/>
					<text x="79" y="199" text-anchor="middle" font-family="Poppins, sans-serif" font-size="20" font-weight="700" fill="#0C2A4A">99</text>
					<text x="122" y="186" font-family="Poppins, sans-serif" font-size="13" font-weight="700" fill="#17805F">Performance</text>
					<text x="122" y="204" font-family="Poppins, sans-serif" font-size="11" fill="#627288">PageSpeed</text>
				</g>

				<!-- SEO score -->
				<g>
					<rect x="452" y="44" width="142" height="52" rx="12" fill="url(#rc-card)" stroke="#B9C6D6" stroke-width="1.5"/>
					<circle cx="481" cy="70" r="13" fill="#17805F" opacity=".18"/>
					<path d="M475.5 70l4 4 8.5-9" fill="none" stroke="#17805F" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
					<text x="506" y="66" font-family="Poppins, sans-serif" font-size="13" font-weight="700" fill="#0C2A4A">SEO</text>
					<text x="506" y="83" font-family="Poppins, sans-serif" font-size="11" fill="#627288">100 / 100</text>
				</g>

				<!-- Organic traffic -->
				<g>
					<rect x="390" y="360" width="196" height="132" rx="14" fill="url(#rc-card)" stroke="#B9C6D6" stroke-width="1.5"/>
					<text x="410" y="388" font-family="Poppins, sans-serif" font-size="13" font-weight="700" fill="#17805F">Organic traffic</text>
					<path d="M410 462l31-16 31 6 31-28 31-12 32-22v72H410Z" fill="url(#rc-area)"/>
					<polyline points="410,462 441,446 472,452 503,424 534,412 566,390" fill="none" stroke="#17805F" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
					<circle cx="566" cy="390" r="4.5" fill="#17805F"/>
				</g>
			</svg>
		</div>
	</div>
...
<section class="proof">
	<div class="container">
		...
		<div class="services-grid proof-grid">
			...
			<a href="/portfolio/paver-sealing-academy" class="service-card">
				<h3>Paver Sealing Academy</h3>
				<div class="stat-row">
					<div class="stat"><span class="stat-number">94</span><span class="stat-label">Performance (mobile)</span></div>
					<div class="stat"><span class="stat-number">100</span><span class="stat-label">SEO</span></div>
				</div>
				<span class="link-arrow">Read the Paver Sealing Academy case study →</span>
			</a>
		</div>
	</div>
</section>
