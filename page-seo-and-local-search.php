...
<section class="service-hero">
	<div class="container service-hero-inner">
		...
		<div class="service-hero-visual"><svg class="hero-illustration" viewBox="0 0 400 300" aria-hidden="true" focusable="false"><rect x="20" y="30" width="360" height="240" rx="16" fill="#1C5991" stroke="#4286C9" stroke-width="1.5"/><rect x="44" y="56" width="312" height="34" rx="17" fill="#123F6F" stroke="#4286C9" stroke-width="1.5"/><circle cx="70" cy="73" r="7.5" fill="none" stroke="#63C89F" stroke-width="2.5"/><path d="M76 79l7 7" stroke="#63C89F" stroke-width="2.5" stroke-linecap="round"/><rect x="96" y="69" width="120" height="8" rx="4" fill="#5E91C1"/><rect x="44" y="106" width="312" height="48" rx="10" fill="#123F6F" stroke="#63C89F" stroke-width="2"/><rect x="62" y="120" width="150" height="9" rx="4.5" fill="#F4F6F9"/><rect x="62" y="136" width="210" height="6" rx="3" fill="#5E91C1"/><path d="M326 140v-22M317 127l9-9 9 9" stroke="#63C89F" stroke-width="2.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/><rect x="44" y="166" width="312" height="42" rx="10" fill="#123F6F"/><rect x="62" y="179" width="118" height="7" rx="3.5" fill="#5E91C1"/><rect x="62" y="193" width="186" height="5" rx="2.5" fill="#235685"/><rect x="44" y="216" width="312" height="42" rx="10" fill="#123F6F"/><rect x="62" y="229" width="96" height="7" rx="3.5" fill="#5E91C1"/><rect x="62" y="243" width="164" height="5" rx="2.5" fill="#235685"/></svg></div>
	</div>
</section>
