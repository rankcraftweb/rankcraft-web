...
<section class="service-hero">
	<div class="container service-hero-inner">
		...
		<div class="service-hero-visual"><svg class="hero-illustration" viewBox="0 0 400 300" aria-hidden="true" focusable="false"><rect x="20" y="30" width="360" height="240" rx="16" fill="#1C5991" stroke="#4286C9" stroke-width="1.5"/><path d="M120 186a80 80 0 0 1 160 0" fill="none" stroke="#235685" stroke-width="16" stroke-linecap="round"/><path d="M120 186a80 80 0 0 1 127-65" fill="none" stroke="#22B885" stroke-width="16" stroke-linecap="round"/><path d="M200 186l38-57" stroke="#F4F6F9" stroke-width="5" stroke-linecap="round"/><circle cx="200" cy="186" r="9" fill="#63C89F"/><rect x="120" y="218" width="46" height="9" rx="4.5" fill="#63C89F"/><rect x="177" y="218" width="46" height="9" rx="4.5" fill="#5E91C1"/><rect x="234" y="218" width="46" height="9" rx="4.5" fill="#5E91C1"/><rect x="120" y="238" width="160" height="6" rx="3" fill="#235685"/></svg></div>
	</div>
</section>
