...
<section class="service-hero">
	<div class="container service-hero-inner">
		...
		<div class="service-hero-visual"><svg class="hero-illustration" viewBox="0 0 400 300" aria-hidden="true" focusable="false"><rect x="24" y="88" width="130" height="118" rx="12" fill="#E2E8F0" stroke="#B9C6D6" stroke-width="1.5"/><path d="M24 114h130" stroke="#B9C6D6" stroke-width="1.5"/><g fill="#B9C6D6"><rect x="40" y="130" width="68" height="7" rx="3.5"/><rect x="40" y="146" width="92" height="6" rx="3"/><rect x="40" y="160" width="58" height="6" rx="3"/></g><rect x="246" y="88" width="130" height="118" rx="12" fill="#E2E8F0" stroke="#B9C6D6" stroke-width="1.5"/><path d="M246 114h130" stroke="#B9C6D6" stroke-width="1.5"/><g fill="#B9C6D6"><rect x="262" y="130" width="68" height="7" rx="3.5"/><rect x="262" y="146" width="92" height="6" rx="3"/><rect x="262" y="160" width="58" height="6" rx="3"/></g><rect x="120" y="50" width="160" height="194" rx="14" fill="#F4F6F9" stroke="#17805F" stroke-width="2"/><path d="M120 84h160" stroke="#B9C6D6" stroke-width="1.5"/><circle cx="139" cy="67" r="4" fill="#8496AC"/><circle cx="153" cy="67" r="4" fill="#8496AC"/><circle cx="167" cy="67" r="4" fill="#8496AC"/><rect x="140" y="104" width="92" height="9" rx="4.5" fill="#0C2A4A"/><g fill="#8496AC"><rect x="140" y="124" width="120" height="7" rx="3.5"/><rect x="140" y="140" width="96" height="7" rx="3.5"/></g><rect x="140" y="166" width="120" height="52" rx="10" fill="#DCE4ED"/><circle cx="166" cy="192" r="14" fill="#17805F"/><path d="M160 192l4 4 8-9" stroke="#0C2A4A" stroke-width="2.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/><rect x="190" y="183" width="56" height="7" rx="3.5" fill="#0C2A4A"/><rect x="190" y="197" width="40" height="6" rx="3" fill="#8496AC"/></svg></div>
	</div>
</section>
